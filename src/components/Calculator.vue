<template>
  <v-card id="calc" max-width="450" class="mx-auto my-12 pa-6">
    <v-container class="pa-0" elevation="3">
      <v-text-field outlined color="teal darken-4" class="teal-darken-4-input text-lg-h6" id="result" type="text" v-model="value" @keypress="isNumber($event)" placeholder="0"></v-text-field>
